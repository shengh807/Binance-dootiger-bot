...
class BinanceAPIManager:
    ...
    def _sell_alt(self, origin_coin: Coin, target_coin: Coin, origin_quantity: float, origin_price: float):
        ...
        self.logger.info(f"SELL QTY {origin_quantity} of <{origin_symbol}>")
