...
class Config:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    def __init__(self):
        ...
        # self.BUY_STD_USDT_BALANCE = os.environ.get("BUY_STD_USDT_BALANCE") or config.get(USER_CFG_SECTION, "buy_std_usdt_balance")
        # self.BACKTEST_START_USDT_BALANCE = os.environ.get("BACKTEST_START_USDT_BALANCE") or config.get(USER_CFG_SECTION, "backtest_start_usdt_balance")

    def set_strategy(self, stratgy: str):
