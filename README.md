...
-   **strategy** - The trading strategy to use. See [`binance_trade_bot/strategies`](binance_dootiger_bot/strategies/README.md) for more information
...
method, [add a new strategy](binance_dootiger_bot/strategies/README.md).
...
## 실행
C:\Python\Binance-trade-bot\venv\Scripts\python.exe -m binance_trade_bot